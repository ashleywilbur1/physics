...
//	btCollisionShape* groundShape = new btStaticPlaneShape(btVector3(0,1,0),50);
	...
	m_collisionShapes.push_back(new btBoxShape(btVector3(0, 20, 10)));
...
//			colShape->calculateLocalInertia(mass,localInertia);
		...
		btCollisionShape* colShape1 = new btBoxShape(btVector3(2, 40, 2));
		m_collisionShapes.push_back(colShape1);
		btCollisionShape* colShape = new btCylinderShape(btVector3(2, 30, 2));
		m_collisionShapes.push_back(colShape);
		btCollisionShape* colShape2 = new btBoxShape(btVector3(2, 40, 2));
		m_collisionShapes.push_back(colShape2);
		btCollisionShape* colShape3 = new btCylinderShape(btVector3(2, 30, 2));
		...
		//pillar 2
		btCollisionShape* shape1 = m_collisionShapes[3];
		//pillar 3
		btCollisionShape* shape2 = m_collisionShapes[4];
		//pillar 4
		btCollisionShape* shape3 = m_collisionShapes[5];
		//positions
		btVector3 pos(0, 40, 0);
		btVector3 pos1(15, 30, 10);
		btVector3 pos2(20, 40, 30);
		btVector3 pos3(40, 30, 30);
		trans.setOrigin(pos);
		trans1.setOrigin(pos1);
		trans2.setOrigin(pos2);		
		trans3.setOrigin(pos3);
		btScalar mass(0.0f);
		// shape->calculateLocalInertia(mass, LocalInertia);

		body000 = localCreateRigidBody(mass, trans1, shape1);
		body000->setAnisotropicFriction(shape1->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);
...
//		body000->setLinearVelocity(btVector3(1, 0, 0));
		...
		body000 = localCreateRigidBody(mass, trans2, shape2);
		body000->setAnisotropicFriction(shape2->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);
		body000->setFriction(0.5);
		//		body000->setLinearVelocity(btVector3(1, 0, 0));
		body000->activate(true);

		body000 = localCreateRigidBody(mass, trans3, shape3);
		body000->setAnisotropicFriction(shape3->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);
		body000->setFriction(0.5);
		//		body000->setLinearVelocity(btVector3(1, 0, 0));
		body000->activate(true);
...
//		btCollisionShape* bShape = new btBoxShape(btVector3(5, 3, 5));
		...
		bShape->addPoint(btVector3(4, 0, 0));
		bShape->addPoint(btVector3(0, 2, 0));
		bShape->addPoint(btVector3(0, 0, 2));
		bShape->addPoint(btVector3(0, 0, -2));
...
//		btCollisionShape* bshape = m_collisionShapes[3];
		btVector3 bpos(10, 30, 0);
		btVector3 bpos1(20, 30, 0);
		btVector3 bpos2(30, 30, 0);
		btVector3 bpos3(40, 30, 0);
		btVector3 bpos4(50, 30, 0);
		btVector3 bpos5(60, 30, 0);
		btVector3 bpos6(70, 30, 0);
		btrans.setOrigin(bpos);
		btrans1.setOrigin(bpos1);
		btrans2.setOrigin(bpos2);
		btrans3.setOrigin(bpos3);
		btrans4.setOrigin(bpos4);
		btrans5.setOrigin(bpos5);
		btrans6.setOrigin(bpos6);
		btScalar bmass(0.0f);
		...
		boid = localCreateRigidBody(bmass, btrans1, bShape);
		boid->setAnisotropicFriction(bShape->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);		
		boid = localCreateRigidBody(bmass, btrans2, bShape);
		boid->setAnisotropicFriction(bShape->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);		
		boid = localCreateRigidBody(bmass, btrans3, bShape);
		boid->setAnisotropicFriction(bShape->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);		
		boid = localCreateRigidBody(bmass, btrans4, bShape);
		boid->setAnisotropicFriction(bShape->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);		
		boid = localCreateRigidBody(bmass, btrans5, bShape);
		boid->setAnisotropicFriction(bShape->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);		
		boid = localCreateRigidBody(bmass, btrans6, bShape);
		boid->setAnisotropicFriction(bShape->getAnisotropicRollingFrictionDirection(), btCollisionObject::CF_ANISOTROPIC_ROLLING_FRICTION);
